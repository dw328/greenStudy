...
<div class="container">
  <h2>회원 가입</h2>
  <!-- (콘테스트(contest))greenStudy => webapp부터 시작 -->
  	<!-- <form name="myform" method="post" action="/greenStudy/study/0918/test06Ok.jsp"> -->
  	<form name="myform" method="post" action="<%=request.getContextPath()%>/study/0918/test06Ok.jsp">
	  <div class="input-group mb-2">
	  	<div class="input-group-text">아이디</div>  
	  	<input type="text" name="mid" id="mid" value="khd1234" class="form-control" />
	  </div>
	  <div class="input-group mb-2">
	  ...
	  <div class="input-group mb-2">
		...
		<div class="row text-center">
  		...
  		<div class="col"><input type="submit" value="확인" class="btn btn-primary"/></div>
  	</div>
  </form>
  <hr/>
</div>
